...
function render() {
  ...
  const titles = {route:'Digitale gewichtloosheid',voorbeeld:'Studio Maan — het voorbeeldproject',tools:'Gereedschappen',werkwijze:'Onze werkwijze',opdrachten:'28 AI-opdrachten',missing:'Pagina niet gevonden'};
