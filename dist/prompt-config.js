...
export const promptConfig = {
  ...
  29:{tools:['antigravity'],when:'Baken de eerste versie af; pas bestaande code alleen aan na een concrete bouwopdracht.',fields:[f('release','Wat hoort in je eerste versie?','Beschrijf het gekozen aanbod, de belangrijkste route en wat later mag.')]},
...
export const seoPromptConfig={
  ...
  4:{tools:['antigravity'],fields:[f('site','Wat is je website?','Het echte HTTPS-adres.'),f('measurement','Wat is je GA4-meet-ID?','Neem de echte G-ID uit je webstream over.'),f('success','Welke handeling telt als een geslaagde aanvraag?','Bijvoorbeeld: een aanvraag die de server heeft ontvangen.'),f('consent','Welke afspraak geldt voor toestemming en meting?','Beschrijf de afgesproken werking bij accepteren en weigeren; als dit nog onbekend is, noteer dat.')],when:'Maak zelf de property en webstream. Leg de meetafspraak vast en laat daarna de websitecode aanpassen.'},
